 ...
 */
public class AirHockeyRenderer2_1 implements GLSurfaceView.Renderer {
    ...
    float[] tableVerticesWithTriangles = {
            ...
            0f, 0.4f, 1f, 1f, 1f,
            -0.5f, 0f, 0.5f, 0f, 0f,
            0.5f, 0f, 0f, 0.5f, 0.2f,
            0.5f, 0.8f, 0f, 0.1f, 0.5f,
            -0.5f, 0.8f, 0.5f, 0.7f, 0.7f,
            -0.5f, 0f, 0f, 0.5f, 0f,

            // Triangle fan2
            0f, -0.4f, 1f, 1f, 1f,
            -0.5f, -0.8f, 0.5f, 0f, 0f,
            0.5f, -0.8f, 0f, 0.5f, 0f,
            0.5f, 0f, 0f, 0f, 0.5f,
            -0.5f, 0f, 0.5f, 0.6f, 0.6f,
            -0.5f, -0.8f, 0f, 0.6f, 0.3f,
    ...
    public AirHockeyRenderer2_1(Context context) {
...
//         使用创建的 OpenGL 程序
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_FAN, 6, 12);
        // 绘制直线
